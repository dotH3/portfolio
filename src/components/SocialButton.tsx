...
const SocialButton: React.FC<SocialButtonProps> = ({ icon, href }) => {
  return (
    <a
      ...
      className="bg-gray-700 hover:bg-gray-600 text-white p-2 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50"
    >
      {icon === "github" && (
        <svg
          className="w-6 h-6"
